...
Public Class LaporanKondisi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Stok.LaporanKondisi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanKondisi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanKondisi = New LaporanKondisi()
        rpt.Site = Me.Site
        Return rpt
    End Function
