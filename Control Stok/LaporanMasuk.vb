...
Public Class LaporanMasuk
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Stok.LaporanMasuk.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanMasuk
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanMasuk = New LaporanMasuk()
        rpt.Site = Me.Site
        Return rpt
    End Function
